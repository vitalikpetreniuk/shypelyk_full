...
$(function() {
    ...
    $('.open-menu').on('click', function(){
        ...
        $('#search-popup').removeClass('on-screen');
        $('#menu-popup').toggleClass('on-screen');

        if($('#menu-popup').hasClass('on-screen'))
        {
            $('body').addClass('popup');
        }else
        {
    ...
    $('.shh-search button').on('click', function(){
        ...
        $('#menu-popup').removeClass('on-screen');
        $('#search-popup').toggleClass('on-screen');

        if($('#search-popup').hasClass('on-screen'))
        {
            $('.popup-overlay').hide();
            $('body').addClass('popup');
        }else
    ...
    $('.item-size_scheme').on('click', function(){
        $('body').addClass('popup');
        $('#sizeguide-popup').addClass('on-screen');
    })
    $('.shh-cart').on('click', function(e){
        e.preventDefault();
        if($(this).hasClass('full') && !$(this).hasClass('close'))
        {
            $(this).addClass('close');
            $('body').addClass('popup popup-cart');
            $('#cart-popup').addClass('on-screen');
        }else if($(this).hasClass('close'))
        {
            $(this).removeClass('close');
            $('body').removeClass('popup popup-cart');
    ...
    $('.popup-close').on('click', function(){
        ...
        $(this).parent().removeClass('on-screen');
    ...
    $('.messenger ul li').on('click', function(){
    ...
    $('div:not(.size-picker):not(.item-size) button.findout').on('click', function(){
        $('#sizeguide-popup').addClass('on-screen findout');
    })
    $('div.size-picker button.findout, div.item-size span.findout').on('click', function(){
        $('#sizeguide-popup').addClass('on-screen findout findout-only');
    })
    $('.popup-back').on('click', function(){
        if($(this).parents('#sizeguide-popup').hasClass('findout-only'))
        {
            $('#sizeguide-popup').removeClass('findout findout-only on-screen');
        }else
        {
            $('#sizeguide-popup').removeClass('findout');
        }
    })
    ...
    $('select').on('mousedown', function(e) {
        ...
        }else if($(this).attr('id') === 'shipping_postoffice')
        {
            $('#postoffice-popup').addClass('on-screen');
        }else if($(this).attr('id') === 'shipping_place')
        {
            $('#delivery-popup').addClass('on-screen');
        }else if($(this).attr('id') === 'payment_type')
        {
...
$(window).on('load', function(){
    ...
    if($('.item-gallery').length)
    {
        $('.slider-for').find('.ig-item').eq(0).find('img').removeAttr('style');
        $('.slider-for').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
